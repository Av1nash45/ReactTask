...
import { editUser, signupUser } from "../../redux/actions/actions";
// import "./UserForm.css";

const { Option } = Select;
const EditForm = ({ username, city, dob, number, email, Province, id }) => {
  ...
  return (
    <>
      {/* <div className="FormHeader"><h1> User Form</h1></div> */}
      <Form
        {...formItemLayout}
        layout={formLayout}
        form={form}
